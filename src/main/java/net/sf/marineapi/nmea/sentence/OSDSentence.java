 ...
 * 
 * Includes (in this order): Heading (degrees true), Heading status {@link DataStatus} <br>
 * Vessel course (degrees true), Course reference {@link ReferenceSystem},<br>
 * Vessel speed, Speed reference (ReferenceSystem), Vessel set (degrees true), vessel drift,<br>
 * Speed units {@link Units}<br>
 * 
 * Example:<br>
